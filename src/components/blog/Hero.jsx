//   here is the blog paga main section hero component
...

{
  ...
  return (
    ...
    <>
 <section className="relative w-full min-h-[260px] md:min-h-[320px] lg:min-h-[380px] flex items-center justify-center overflow-hidden  pb-6 md:pb-10 lg:pb-12">
      ...
      <div className="relative z-10 max-w-5xl px-4 text-center">
        ...
        {/* Explore Button */}
        <button className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#1F40B0] px-4 py-0.5 text-xs md:text-sm text-blue-400  transition">
          <img src="../../src/assets/Explore_icon.svg" alt="Search Icon" className="h-8 w-8" />
           
          <span className="h-2 w-2 font-700 font-['Halvetica_Neue ']" />
          Explore
        </button>

        {/* Heading */}
        {/* <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px]  tracking-tight text-white font-['Halvetica neue'] font-medium">
          Insights, Ideas &{" "}
          <span className="text-[#2DD4C8]">Innovation</span>
        </h1> */}
...
">
  Insights, Ideas &{" "}
  <span className="text-[#31C8F0]">Innovation</span>
</h1>


        {/* Description */}
        {/* <p className="mt-3 max-w-3xl mx-auto text-sm sm:text-base md:text-lg text-[#9C9C9C] leading-relaxed">
          Explore the latest in translation technology, product updates, and
          industry <br/> trends. Stay informed with expert insights from the Anslation
          team.
        </p> */}
