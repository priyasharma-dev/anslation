...
//   Grid3X3,
// } from "lucide-react";
// import ProductsTimeline from "./ProductsTimeline"; // Assuming ProductsTimeline.jsx is in the same directory
// import "./Explore.css";

// const ITEMS = [
//   { id: 1, label: "Solutions", icon: Layers, link: "#" },
//   { id: 2, label: "Services", icon: Server, link: "#" },
//   { id: 3, label: "Performance", icon: BarChart3, link: "#" },
//   { id: 4, label: "Infrastructure", icon: Grid3X3, link: "#" },
//   { id: 5, label: "Inventory", icon: Package, link: "#" },
//   { id: 6, label: "Marketing", icon: Megaphone, link: "#" },
//   { id: 7, label: "Microtools", icon: Wrench, link: "#" },
//   { id: 8, label: "Products", icon: Monitor, link: "#" },
// ];
...
//     const radius = window.innerWidth * 0.2; // Adjust radius based on window width
...
//               const len = Math.hypot(positions[i].x, positions[i].y);
//               const rot = (positions[i].angle * 180) / Math.PI;
//               return (
...
//                     className="line"
//                     initial={{
//                       transform: `translate(-50%, -50%) rotate(${rot}deg) scaleX(0)`,
//                     }}
//                     animate={{
//                       transform: `translate(-50%, -50%) rotate(${rot}deg) scaleX(1)`,
//                     }}
//                     exit={{
//                       transform: `translate(-50%, -50%) rotate(${rot}deg) scaleX(0)`,
//                     }}
...
//       {selectedNode === "Products" && <ProductsTimeline />}
//     </div>
//   );
// }
