                            ...
                            <div className='py-10' >
                                <motion.button 
                                 whileHover={{
                                  ...
                                  transition={{ duration: 0.5 }}
                                 className='w-96 py-2 bg-[#286CE6] cursor-pointer rounded ' >Apply Now</motion.button>
                            </div>
                                ...
                                <a href="">
                                    <motion.img
                                     whileHover={{
                                      ...
                                      transition={{ duration: 0.9}}
                                     src={fb} alt="facebook_icon" className='w-16' />
                                </a>
                                <a href="">
                                    <motion.img 
                                     whileHover={{
                                      ...
                                      transition={{ duration: 0.9}}
                                    src={instagram} alt="facebook_icon" className='w-16' />
                                </a>
                                <a href="">
                                    <motion.img 
                                     whileHover={{
                                      ...
                                      transition={{ duration: 0.9}}
                                    src={twitter} alt="facebook_icon" className='w-16' />
                                </a>
                                <a href="">
                                    <motion.img 
                                     whileHover={{
                                      ...
                                      transition={{ duration: 0.9}}
                                    src={LinkedIn} alt="facebook_icon" className='w-16' />
                                </a>
