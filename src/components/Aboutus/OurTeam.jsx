...
//   return (
//     <div className="w-[1248px] mt-[90px] ml-[130px] mb-10">
...
//       <Typography sx={{ fontWeight: 400, fontSize: "36px", textAlign: "center", pt:1 }}>
//         Our Core Value
//       </Typography>
...
/* ---------------- REUSABLE COMPONENTS ---------------- */
const Row = ({ children }) => (
  <Stack direction="row" spacing="32px" justifyContent="center" mt="32px">
    {children}
  </Stack>
);
...
const coreValues = [
  {
    ...
    desc:
      "We create innovative solutions that keep our clients ahead of the curve. We embrace new ideas, constantly evolving our products to meet the changing demands of the tech industry.",
    bg: "#FF6B00",
    icon: <path d="M12 2a5 5 0 00-5 5c0 2.8 2 4.3 2 6.5A3 3 0 00112 19a3 3 0 003-5.5c0-2.2 2-3.7 2-6.5a5 5 0 00-5-5z" fill="white" />,
  },
  {
    id: "integrity",
    title: "Integrity",
  ...
  },
  {
    ...
    desc:
      "Teamwork is key to our success. We work closely with our clients to understand their challenges and create customized solutions that drive real impact.",
    bg: "#4A7DFD",
    icon: <path d="M3 12h6l4 8 4-16h4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />,
  },
  {
    id: "customer",
    title: "Customer Focus",
    ...
    desc:
      "Our clients are at the heart of everything we do. We listen to feedback and prioritize satisfaction, making sure our solutions are always aligned with their needs.",
    bg: "#FF4F8B",
    icon: <path d="M12 21s-6-4.35-9-7.5C1.8 10.9 4 6 8 6c1.8 0 3 1 4 1s2.2-1 4-1c4 0 6.2 4.9 5 7.5C18 16.65 12 21 12 21z" fill="white" />,
  },
  {
    id: "sustainability",
    title: "Sustainability",
    ...
    desc:
      "We are committed to creating eco-friendly solutions that reduce environmental impact. We focus on building energy-efficient, cloud-first products.",
    bg: "#2AC95F",
    icon: <path d="M5 12a7 7 0 0114 0 9 9 0 01-9 9 9 9 0 01-4-1" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />,
  },
  {
    id: "excellence",
    title: "Excellence",
    ...
    desc:
      "We deliver high-performance, secure, and user-friendly software that meets the highest standards of quality and reliability.",
    bg: "#A66BFF",
    icon: <path d="M12 2l3 6 6 .5-4.5 3.5L18 19l-6-3-6 3 .5-7L2 8.5 8 8 12 2z" fill="white" />,
  },
  {
    id: "agility",
    title: "Agility",
    ...
    desc:
      "The tech world is constantly evolving. We stay flexible and responsive to new trends, adapting quickly to meet changing client needs.",
    bg: "#FF3D3D",
    icon: <path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" fill="white" />,
  },
];
...
export default function OurTeam() {
  return (
    <Box sx={{ width: "1248px", ml: "130px", mt: "90px", mb: "40px",
