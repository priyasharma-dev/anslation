...
<div className="flex flex-row w-[1248px] h-auto pb-10 gap-16 ml-[96px]">
  {/* Story */}
  <div class="flex flex-col w-[592px] gap-6">
  <div class=" font-['Helvetica_Neue'] font-medium text-[36px] leading-[40px] tracking-normal text-white">Our Story </div>
  <Typography className="font-['Helvetica_Neue'] font-normal text-[16px] leading-[24px] tracking-normal text-[#94A3B8]">
    At Anslation, we are redefining the way businesses interact with technology.
As a leading provider of innovative software solutions, we deliver cutting-
edge products that help organizations scale and thrive in the digital age.
  </Typography>
...
have built a suite of tools designed to optimize business operations and
elevate performance.
  </Typography>
...
<div class="w-[280px] h-[250px] rounded-3xl overflow-hidden mt-[80px] ml-[250px]">
  <img
    src="/svg/story.png"
